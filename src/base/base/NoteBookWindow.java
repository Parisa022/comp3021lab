...
public class NoteBookWindow extends Application {
	...
	private void updateListView(List<Note> arr, Boolean search) {
		ArrayList<String> list = new ArrayList<String>();

		// TODO populate the list object with all the titles of the
		// currentFolder
		if (search == false) {
		ArrayList<Folder> fn = this.noteBook.getFolders();
		for (Folder f: fn) {
			if (currentFolder.equals(f.getName())) {
				for (Note n: f.getNotes()) {
					list.add(n.getTitle());
